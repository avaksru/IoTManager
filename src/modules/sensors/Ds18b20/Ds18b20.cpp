...
public:
    ...
    Ds18b20(String parameters) : IoTItem(parameters)
    {
        ...
        if (addr == "")
        {
            ...
            SerialPrint("I", "Sensor " + String(_id.c_str()), "index: " + (String)index + " addr: " + String(addrStr));
        }
        else
        {
    ...
    void doByInterval()
    {
        ...
        if (value.valD != DEVICE_DISCONNECTED_C)
            ...
            SerialPrint("E", "Sensor Ds18b20", "Error", String(_id.c_str()));
    }
    //=======================================================================================================
...
void clearDs18b20Resources() {
    for (auto const& [pin, ow] : oneWireTemperatureArray) {
        delete ow;
    }
    oneWireTemperatureArray.clear();
}
